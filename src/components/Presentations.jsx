    ...
    <div className='flex flex-col md:flex-row items-center justify-center my-10 pt-8'>
      <div className='w-full md:w-7/12'>
        ...
        <div className='py-5 text-center' style={{ position: 'relative', paddingBottom: '56.25%' }}>
          <iframe src='/portfolio/assets/trimmed-tech-talk.mp4' width='100%' height='100%' style={{ position: 'absolute', top: '0', left: '0', width: '100%', height: '100%' }} frameBorder='0' allowFullScreen='' title='Embedded post'></iframe>
        </div>
      </div>
    </div>
  );
